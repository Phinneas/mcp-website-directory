---
title: "MCP Server Architecture Diagram – From Spaghetti Integrations to Lego Bricks"
...
*Caption: Host app embeds MCP clients; each client speaks JSON-RPC 2.0 over stdio or HTTP/SSE to an isolated MCP server. The LLM only sees tool names, descriptions, and JSON schemas—not implementation details.*
...
- **[Stripe MCP Server](https://www.mymcpshelf.com)** – Handles OAuth2 for payment processing, serves multiple merchants
- **[Notion MCP Server](https://www.mymcpshelf.com)** – Multi-workspace, multi-user access with centralized rate limiting
- **[AWS Bedrock Knowledge Bases](https://www.mymcpshelf.com)** – Cloud-native, IAM-secured document retrieval
...
|----------------------|-------------------|
| `github-issues-server` <br/>(1 tool: `create_issue`) | `github-server` <br/>(8 tools: repos, issues, PRs, releases…) |
...
- **Single-purpose done right:** [SQLite MCP](https://www.mymcpshelf.com) – One job: query SQLite databases. No feature creep.
- **Multi-tool done right:** [GitHub Official MCP](https://www.mymcpshelf.com) – 20+ tools, but all GitHub-scoped (repos, issues, PRs, actions).
...
1. ⭐ **Star the official [MCP repo](https://github.com/modelcontextprotocol)** to follow protocol updates

2. 🚀 **Submit your server to [awesome-mcp](https://github.com/modelcontextprotocol/awesome-mcp)** once you've built something useful

3. 🔍 **Browse 180+ ready-made servers** organized by category:
   - **[Database Tools](https://www.mymcpshelf.com)** – SQLite, PostgreSQL, MongoDB, MySQL
   - **[Communication](https://www.mymcpshelf.com)** – Slack, Discord, Telegram, WhatsApp
   - **[File Management](https://www.mymcpshelf.com)** – Google Drive, AWS S3, local filesystem
   - **[Developer Tools](https://www.mymcpshelf.com)** – GitHub, GitLab, Docker, Kubernetes
   - **[All Servers →](https://www.mymcpshelf.com)**
