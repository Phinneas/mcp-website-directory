...
|---|---|---|---|
| [Coding agent](#coding-agent) | 4–6 | stdio | Context window overload |
| [Data analysis agent](#data-agent) | 3–5 | Streamable HTTP | Intermediate result token consumption |
| [Customer support agent](#support-agent) | 4–7 | Streamable HTTP | Duplicate writes from LLM retries |
...
## Coding Agent Architecture {#coding-agent}
...
## Data Analysis Agent Architecture {#data-agent}
...
## Customer Support Agent Architecture {#support-agent}
