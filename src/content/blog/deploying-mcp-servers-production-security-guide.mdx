...
**Cost Control:**
- Trim large responses >100 kB; return a signed URL to cloud storage instead.
...
- [ ] **Load test:** k6 script at 2× expected RPS for 10 min; p99 <600 ms
...
- [ ] **Canary stage:** 5 % traffic for 30 min; automatic rollback on 5xx >1 %

### Monitoring
- [ ] **Central logging:** Fluent-bit → Loki; labels `{tenant, tool}`
- [ ] **Dashboard:** Grafana template variable by `tool`; SLO burn-rate alerts
- [ ] **Alerts:** PagerDuty page on 5xx >5 % for 5 min; Slack on auth-failure spike
